# Ender Portals — une base de poche derrière une porte d'obsidienne

Mod **Minecraft 1.21.1 / NeoForge**. Vous forgez une porte, vous l'éveillez au
prix d'un rituel, et elle s'ouvre sur un monde qui n'existait pas : **le monde
de l'Ender**, une masse souterraine translucide où viennent se reposer les blocs
détruits. Derrière cette porte, une parcelle entière vous appartient. Vous
l'emportez partout : la porte se dématérialise dans votre poche et se repose
où vous voulez.

Version courante : **0.16.0**.
...
* **Une base transportable.** Une porte de deux blocs, posée d'un clic, qui
  contient une parcelle de 8192 blocs de côté dans une dimension à part.
* **Un monde à creuser.** Le monde de l'Ender est plein d'un bout à l'autre :
  pas une caverne, pas un tunnel. On s'y déplace en taillant sa galerie.
* **Un stockage à distance.** Où que vous soyez, videz votre inventaire dans
  les coffres de votre base d'un simple clic droit.
...
Y 70**, en petits amas — il faut y aller, c'est le premier voyage du mod.
Une **pioche en fer** suffit à le casser ; il rend des **Cristaux de l'Ender**.
Fortune augmente le rendement, Silk Touch ramasse le bloc de minerai intact.
...
Munissez-vous d'une **Mace** vanilla (heavy core + breeze rod). Posez la porte
où vous voulez, montez à **20 blocs au moins** au-dessus d'elle, sautez, et
...
sa salle intérieure vient d'être taillée dans le monde de l'Ender. La Mace n'est
pas consommée, seulement un peu usée.
...
À défaut, l'enchantement **« Brisure d'Espace-Temps »** permet à n'importe
quelle pioche de les casser avec butin, à vitesse correcte. C'est un
enchantement de **trésor**, comme Raccommodage : on le trouve en butin ou en
troc avec un bibliothécaire, jamais à la table d'enchantement.
...
matérialise rien, n'ouvre rien, et ne se relie pas à votre porte. Personne ne
peut entrer chez vous en ramassant votre trousseau.

### Perdre sa clé ne coûte pas sa base

Reforgez-en une (cristal, perle, lingot d'or) et faites un clic droit dans le
vide : elle se relie à votre porte, où qu'elle soit. C'est important, parce
qu'une porte dématérialisée n'offre plus rien à cliquer et que le rituel refuse
d'en éveiller une seconde — sans cette relance, la base serait perdue pour de
bon.

### Le rappel ne peut pas échouer

Poser la porte au sol peut être refusé : vous avez désigné l'endroit, « pas
assez de place » est une réponse honnête. Mais **le rappel depuis l'intérieur
est votre seule issue** — votre parcelle est murée de bedrock sur des milliers
de blocs. Il ne peut donc pas échouer, et essaie trois emplacements dans
l'ordre :

1. l'endroit exact où vous l'aviez laissée ;
2. sinon un espace libre au voisinage — 8 blocs autour, 4 au-dessus ou en
   dessous, par cercles croissants, sur du sol solide ;
3. sinon votre **point de réapparition**.

Dans les deux derniers cas, les coordonnées vous sont annoncées. Sans cela, il
suffirait qu'un joueur bâtisse sur vos deux blocs, ou qu'un arbre y pousse, pour
que votre base devienne une prison.
...
De rares **filons de froglight perlescent** traversent la masse en longs semis
de lueurs violettes. Ce sont les seuls repères d'un monde qui se ressemble
partout — et la seule lumière : partout ailleurs, l'obscurité est totale. Une
cendre claire tombe en continu.
...
Chaque porte éveillée reçoit sa **case de 8192 blocs de côté**, attribuée en
spirale autour de l'origine. Vous y bâtissez ce que vous voulez : base, fermes,
stockage. **Les lits fonctionnent** : on y dort et on y fixe son point de
réapparition. Les ancres de réapparition, non — elles explosent ici comme dans
l'Overworld. Les portails du Nether ne s'y allument pas.

Les cases sont **séparées par un quadrillage de murs de bedrock** de deux blocs
d'épaisseur, montant du plancher au plafond du monde. On ne peut ni marcher
jusque chez le voisin, ni passer par-dessus, ni par-dessous. La seule façon de
se rejoindre est le Passage des Alliés, et il demande le consentement des deux.
...
l'opposé de l'obsidienne de la Porte de l'Ender. Il se pose **dans le monde de
l'Ender uniquement**. Seul, il reste scellé : il faut lui **accoler un Contrôle
de l'amitié**, le pavé numérique qui commande tout.
...
Pour refermer, cliquez le nom entouré de vert. Il faudra refaire la poignée de
main pour rouvrir.
...
* **Le Transmetteur d'objet** (7 blocs de fer, 1 bloc de redstone, 1 coffre de
  l'Ender) se pose **dans le monde de l'Ender**, contre vos rangements. Il
  fédère tout le réseau accolé : de bloc en bloc, le réseau grandit.
...
Le monde de l'Ender se déclare auprès des shaders **comme le Nether** : c'est ce
qui lui donne son rendu souterrain, sans horizon ni ciel, avec son brouillard et
sa tempête de cendres. **Il n'y a rien à configurer.** Testé avec Complementary
Reimagined.
...
```bash
./gradlew build
# → build/libs/enderportals-0.16.0.jar
```
